...
The flow function is commonly described as a function of the stress tensor invariants and the forces $q$ associated with the internal variables related to the hardening-softening phenomenon $f(\stress,q) = f(I_1,J_2,\theta,q)$ with
...
\begin{equation} \label{eq_plastic_flow}
	\strainp = \dot \lambda \dgds ~~~ \text{with} ~~~ \dgds = \dfrac{\partial g}{\partial \stress} \;,
\end{equation}
